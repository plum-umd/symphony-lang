...
ppNatAllyn ∷ IPrecision → ℕ → Doc
ppNatAllyn p n = concat [pretty n,ppLit "n",pretty p]

ppIntAllyn ∷ IPrecision → ℤ → Doc
ppIntAllyn p i = concat [pretty i,pretty p]
...
ppFltAllyn ∷ FPrecision → 𝔻 → Doc
ppFltAllyn p d = concat [pretty d,pretty p]
