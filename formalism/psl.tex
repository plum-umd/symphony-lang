...
\begin{array}{c}
 ...
 %    } \qquad
  ...
  n = n_1 \oplus n_2\\
    ...
    {
    \seval{\env}{m}{\ebinop{v_1}{v_2}}{\env}{n}
    }\qquad
  ...
  v = \vshare{m}{\psi}{\ebinop{e_1}{e_2}}
    }
    {
    \seval{\env}{m}{\ebinop{v_1}{v_2}}{\env}{v}
    }\\\\
    ...
    \inferrule*[lab=S-Reveal]
  {
    ...
    {
    \seval{\env}{m}{\efix{f}{x}{e}}{\env}{\vclos{\env}{\efix{f}{x}{e}}}
    }\\\\
  ...
  \getat{m}{v} = \vcrash
    ...
    {
    \eval{\env}{m}{\eproj{i}{v}}{\vcrash}\\\\
    \eval{\env}{m}{\eunfold{v}}{\vcrash}
    }\\\\
