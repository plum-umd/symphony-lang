...
\texttt{par{b} f 1} would fail if changed to \texttt{par{c} f 1}. This
is because the closure $f$ is not located at $c$ so it can't be
called. If the last line was \texttt{par{a} f 1} then $\epair{0}{1}$
would be returned again, but this time $0$ and $1$ would both be
located at $a$.
