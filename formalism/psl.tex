...
(located at $Q = \emptyset$) is returned. \mwh{Fix: We should have a
  ``crash'' value that can be given any type, but should never be
  accessed because it will always have $\emptyset$ as its locator}
