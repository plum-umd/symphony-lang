...
$e$ with $\emptyset$ as the mode is not equivalent: Skipping
evaluation means avoiding the possibility of non-termination or
getting stuck on other rules due to inaccessible values.) Otherwise,
evaluation takes place in environment $\sigma'$, which is the current
environment located at $P$, which is constructed by intersecting
