...
This document defines a core calculus modeling PSL, the \emph{Pantheon
  Source Language}.

\mwh{TODO}
\begin{itemize}
\item Give it a name; fix title to match
\item How it differs from the real language, and why that's OK
\item That it was inspired by Wysteria, but generalizes it
\item The outline of the document
\end{itemize}
