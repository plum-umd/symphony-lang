...
\mwh{To do:}
\begin{itemize}
\item Reveal — remove the $\psi$ annotation (think of this as being figured out by the typeclass)
\item Curried functions —> is ‘m’ on the arrow affected?
\item Think about $\psi$ working for cleartext and make sure tings work 
\item singleton share allows you to treat reveal as send
\item encode as send{a}{a,b,c}
\end{itemize}
